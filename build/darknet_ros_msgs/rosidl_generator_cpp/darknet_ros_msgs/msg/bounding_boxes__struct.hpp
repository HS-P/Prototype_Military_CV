...
#ifndef DARKNET_ROS_MSGS__MSG__BOUNDING_BOXES__STRUCT_HPP_
#define DARKNET_ROS_MSGS__MSG__BOUNDING_BOXES__STRUCT_HPP_
...
struct BoundingBoxes_
{
  ...
  explicit BoundingBoxes_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    image_header(_init)
  {
    (void)_init;
  ...
  explicit BoundingBoxes_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
  ...
  using _bounding_boxes_type =
    std::vector<darknet_ros_msgs::msg::BoundingBox_<ContainerAllocator>, typename ContainerAllocator::template rebind<darknet_ros_msgs::msg::BoundingBox_<ContainerAllocator>>::other>;
  ...
  Type & set__bounding_boxes(
    const std::vector<darknet_ros_msgs::msg::BoundingBox_<ContainerAllocator>, typename ContainerAllocator::template rebind<darknet_ros_msgs::msg::BoundingBox_<ContainerAllocator>>::other> & _arg)
  {
...
#endif  // DARKNET_ROS_MSGS__MSG__BOUNDING_BOXES__STRUCT_HPP_
