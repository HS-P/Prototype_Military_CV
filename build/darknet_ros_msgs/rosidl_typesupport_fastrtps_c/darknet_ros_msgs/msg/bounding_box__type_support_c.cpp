...
#include "darknet_ros_msgs/msg/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // class_id
#include "rosidl_generator_c/string_functions.h"  // class_id
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: class_id
  {
    const rosidl_generator_c__String * str = &ros_message->class_id;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: class_id
  {
    ...
    if (!ros_message->class_id.data) {
      rosidl_generator_c__String__init(&ros_message->class_id);
    }
...
{
  return max_serialized_size_darknet_ros_msgs__msg__BoundingBox(
    full_bounded, 0);
}
