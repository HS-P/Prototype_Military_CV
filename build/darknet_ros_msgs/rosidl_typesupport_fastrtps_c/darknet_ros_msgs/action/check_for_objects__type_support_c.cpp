...
#include "darknet_ros_msgs/action/check_for_objects__functions.h"
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_Goal(
    full_bounded, 0);
}
...
#include "darknet_ros_msgs/msg/bounding_boxes__functions.h"  // bounding_boxes
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "darknet_ros_msgs/action/check_for_objects__functions.h"  // goal
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "darknet_ros_msgs/action/check_for_objects__functions.h"  // result
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "darknet_ros_msgs/action/check_for_objects__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
{
  return max_serialized_size_darknet_ros_msgs__action__CheckForObjects_FeedbackMessage(
    full_bounded, 0);
}
