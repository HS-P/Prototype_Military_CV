...
#ifndef DARKNET_ROS_MSGS__MSG__BOUNDING_BOX__STRUCT_H_
#define DARKNET_ROS_MSGS__MSG__BOUNDING_BOX__STRUCT_H_
...
typedef struct darknet_ros_msgs__msg__BoundingBox
{
  ...
  int64_t ymax;
  int16_t id;
  rosidl_generator_c__String class_id;
...
#endif  // DARKNET_ROS_MSGS__MSG__BOUNDING_BOX__STRUCT_H_
